"""phybot mini velocity environment configurations."""
...
def phybot_mini_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create phybot mini rough terrain velocity configuration."""
  ...
  feet_ground_cfg = ContactSensorCfg(
    ...
    primary=ContactMatch(
      mode="subtree",
      pattern=r"^(right_ankle_roll|right_ankle_roll)$",
      entity="robot",
    ),
...
def phybot_mini_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create phybot mini flat terrain velocity configuration."""
  cfg = phybot_mini_rough_env_cfg(play=play)
